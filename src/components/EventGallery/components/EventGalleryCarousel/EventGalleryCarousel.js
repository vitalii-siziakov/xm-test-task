...
import { ReactComponent as PrevSlideIcon } from '@images/svg/prev-arrow-icon.svg';
import { ReactComponent as NextSlideIcon } from '@images/svg/next-arrow-icon.svg';
        ...
        <div className='embla__viewport' ref={emblaRef}>
          <div className='embla__container'>
            <div className='embla__slide'>
              <img className='embla__slide__img' src={plugImage} alt='Your alt text' />
            </div>
            <div className='embla__slide'>
              <img className='embla__slide__img' src={plugImage} alt='Your alt text' />
            </div>
